...
namespace BitNetSharp.Core
{
    ...
    /// </summary>
    public sealed partial class CPUTensorOPProvider : IOPProvider2
    {
        ...
        {
            OPProviderCommon.ForwardLmHeadTensor(input, embeddingWeights, rowLength, vocabularySize, output, ThreadCount);
        }
    }
}
